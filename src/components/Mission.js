  ...
  return (
    ...
    >
      ...
      >
        ...
        with no place to go. Light My Fire (LMF) helps local fire departments by
        ...
        of Puget Sound was organized in an effort to help families affected by
        fire damage in the western Washington area.
      </p>
    </section>
  );
};
